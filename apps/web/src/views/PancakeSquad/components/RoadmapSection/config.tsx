...
const config = ({ t }: FAQsType) => [
  ...
  },
  {
    ...
    icon: '👨‍💻',
    description: [
      t('Upgrade from Uniswap based UI to DynastySwap based UI'),
  ...
  },
  {
    ...
    description: [
      ...
      t('Provide the best trading rates for any token on DynastySwap'),
    ],
    reached: '02-2024',
  },
  {
  ...
  },
  {
    ...
    icon: '🚀🚀',
    description: [t('Expand to a lot of blockchains, making DynastySwap the single place traders need to visit on all the chains.')],
    reached: '05-2024',
  },
]
